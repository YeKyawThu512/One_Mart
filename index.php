...
{
    $post = $MySQLiconn->query("SELECT * FROM onemart_post order by RAND()");
    $post_list = $post->num_rows;
}
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
            ...
            <div class="">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                        ...
                        <?php if($ser_count == 0){ ?>
                            <center>
                                <a class="btn w3-card-8 zawgyi" style="color:white;background-color: #02b875;width: 250px;margin-top: 100px;" href="special_order.php">
                                    Special Order
                                </a>
                            </center>
                        <?php } ?>
        ...
        <div>
            <div class="row">
                ...
                <?php  while($col=$post->fetch_array()) { 
                    $sid      = $col['shop_id'];
                    $page_id  = $col['id'];
                                ...
                                <div class="col-2">
                                    ...
                                    <ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--bottom-right" for="save<?php echo $col['id']; ?>">
                                        <li class="mdl-menu__item"> 
                                            ...
                                            <a style="text-decoration: none;" href="index.php?del_id=<?php echo $col['id']; ?>">
                                                Delete 
                                            </a>
                                        </li>
                                    </ul>
                ...
                <?php } ?>
                    ...
                    <div class="col-4" style="text-align: center;color: #02b875;">
                        ...
                        <ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--top-right" for="share<?php echo $col['id']; ?>">
                            <li class="mdl-menu__item">   &nbsp; 
                                <a style="text-decoration: none;" href="https://www.facebook.com/sharer/sharer.php?u=http://wit2019-user18.webstarterz.com/OneMart/detail.php?pid=<?php echo $col['id']; ?>"> Facebook </a>
                            </li>
                            <li class="mdl-menu__item">   &nbsp; 
                                <a style="text-decoration: none;" href="fb-messenger://share/?link=http://wit2019-user18.webstarterz.com/OneMart/detail.php?pid=<?php echo $col['id']; ?>"> Messenger </a>
                            </li>
                            <li class="mdl-menu__item">   &nbsp;
                                <a style="text-decoration: none;" href="viber://forward?text=http://wit2019-user18.webstarterz.com/OneMart/detail.php?pid=<?php echo $col['id']; ?>"> Viber </a>
                            </li>
                            <li class="mdl-menu__item">   &nbsp; 
                                <a style="text-decoration: none;" href="mailto:?subject=OneMart.com.mm&body=<?php echo $col['name']; ?> : Price(<?php echo $col['price']; ?>) : http://wit2019-user18.webstarterz.com/OneMart/detail.php?pid=<?php echo $col['id']; ?>"> Mail </a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4" style="text-align: center;color: #02b875;">
                        ...
                        <ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--top-right" for="share<?php echo $col['id']; ?>">
                            ...
                            <li class="mdl-menu__item">   &nbsp; 
                                <a style="text-decoration: none;" href="mailto:?subject=OneMart&body=<?php echo $col['name']; ?> : Price(<?php echo $col['price']; ?>) : http://wit2019-user18.webstarterz.com/OneMart/detail.php?pid=<?php echo $col['id']; ?>"> Mail </a>
                            </li>
                        </ul>
                    </div>
                </div>

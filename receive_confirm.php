...
$result = $MySQLiconn->query("SELECT * FROM onemart_tempo WHERE user_phone = '+959692280652' and cart = '0' and order_id = '1' and pending = '0' order by created_date desc ");
...
<html lang="en">
  <head>
    ...
    <style>
                       ...
                       <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <th scope="row" class="zawgyi"> 
                                    <?php echo $ac['shop_name']; ?> 
                                 </th>
                                ...
                                <th scope="row" class="zawgyi"> <?php echo $row['name']; ?> </th>

                                <th scope="row"> <?php echo number_format($qty); ?></th>

                                <th scope="row"> 
                                    <?php echo number_format($row['price']); ?> KS
                                </th>

                                <th scope="row"> 
                                    <?php echo number_format($row['price'] * $qty); ?> KS
                                </th>       
                            </tr>
        ...
        <?php
            $result = $MySQLiconn->query("SELECT id FROM onemart_acc WHERE phone = '+959692280652' LIMIT 1 ");
